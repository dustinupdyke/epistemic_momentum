...
def main():
    ...
    results11 = iterative(True, 1000, True) #stuxnet=False, lookback=9999, sere = False
    ...
    with open("output/stuxnet_sere_reevaluation_results_{}.txt".format(date), "w") as f:
    ...
    # with open("output/stuxnet_sere_reevaluation_output_reevals_{}.txt".format(date), "w") as f:
    ...
    # with open("output/stuxnet_sere_reevaluation_output_raw_debug_{}.txt".format(date), "w") as f:
